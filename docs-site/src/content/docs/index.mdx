...
- **Account Backup & Recovery** - Encrypted `.swarmid` file export/import and Swarm-based account restoration
...
- [Architecture Overview](/architecture) - Deep dive into the system design, including backup & recovery
